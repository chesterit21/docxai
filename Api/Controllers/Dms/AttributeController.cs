...
namespace Docubase.api.Controllers.Dms
{
	...
	[Route("[controller]")]
	[ApiController]
	public class AttributeController(AttributesService service) : ControllerBase
	{
		//[UserAction(UserAction.Read)]
		[AllowAnonymous]
		[HttpGet]
		public async Task<IActionResult> Get([FromQuery] RequestAttrList filter)
		{
		...
		[HttpPost]
		public async Task<IActionResult> Post(RequestAddAttributes request)
		{
		...
		[HttpPut]
		public async Task<IActionResult> Put(RequestAttributes request)
		{
