...
export default function ModalViewAiModel({ open, setOpen, eventData }: any) {
    ...
    >
      ...
      <div style={{ padding: 24, paddingBottom: 10 }}>
        <div style={{ marginBottom: 16 }}>
          ...
          <p style={{ marginBottom: 0 }}>{eventData?.modelName || "-"}</p>
        </div>
        <div style={{ marginBottom: 16 }}>
          <p className="font-bold" style={{ marginBottom: 8 }}>
            API URL
          </p>
          <p style={{ marginBottom: 0 }}>{eventData?.urlApi || "-"}</p>
        </div>
        <div style={{ marginBottom: 16 }}>
          <p className="font-bold" style={{ marginBottom: 8 }}>
            API Key
          </p>
          <p style={{ marginBottom: 0 }}>{eventData?.apiKey ? "********" : "-"}</p>
        </div>
        <div style={{ marginBottom: 16 }}>
          <p className="font-bold" style={{ marginBottom: 8 }}>
            Provider
          </p>
          <p style={{ marginBottom: 0 }}>{eventData?.provider || "-"}</p>
        </div>
        <div style={{ marginBottom: 16 }}>
          <p className="font-bold" style={{ marginBottom: 8 }}>
            Max Token
          </p>
          <p style={{ marginBottom: 0 }}>{eventData?.maxToken || "0"}</p>
        </div>
