...
const TableList = () => {
  ...
  const getDataTable = () => {
    ...
    apiClient
      .get(
        `/attributecollections/recyclebin?search=${search}&Page=${page}&Limit=${pageLength}`
      )
      .then(({ data }) => {
  ...
  const handleClickRestore = async (value: any) => {
    ...
    await apiClient
      .put(`/attributecollections/undelete?id=${id}`)
      .then(({ data }) => {
        console.log(data);
        getDataTable();
  ...
  const handleDeleteOk = () => {
    if (eventData) {
      ...
      apiClient
        .delete(`/attributecollections/hard-delete?id=${eventData}`)
        .then(({ data }) => {
  ...
  const handleEmptyOk = () => {
    ...
    apiClient
      .delete(`/attributecollections/empty-recyclebin`)
      .then(({ data }) => {
