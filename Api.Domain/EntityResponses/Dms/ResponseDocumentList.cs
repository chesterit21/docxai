...
{
	public class ResponseDocumentPagination
	{
		public List<ResponseDocumentList> Record { get; set; }
		public long TotalRecord { get; set; }
	}

	public class ResponseDocumentList
	{
		...
		public string DocumentSticky { get; set; }
